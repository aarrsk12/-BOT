...
$frm_submit = '<div class="btn_insert">
    ...
    <a href="./notice_form.php?wr_id='.$_GET["wr_id"].'&w=u" class="btn_insertadd">수정</a>'.PHP_EOL;
$frm_submit .= '</div>';
...
<section id="anc_bo_basic">
    <div id="container_title">공지사항 내용</div>
    <?php echo $pg_anchor ?>
	...
	$(function() {
		...
		$('.shop_delete').on('click', function(){
			...
			if(result){
				...
				window.location.href = "notice_delete.php?wr_id="+num;
			}else{
