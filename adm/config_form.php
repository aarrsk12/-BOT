...
<section id="anc_cf_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
			...
			<th scope="row"><label for="cf_1">은행명</label></th>
            <td><input type="text" name="cf_1" value="<?php echo $config['cf_1'] ?>" id="cf_1" required class="required frm_input" size="40"></td>
        </tr>
        <tr>
			...
			<th scope="row"><label for="cf_2">계좌번호</label></th>
            <td><input type="text" name="cf_2" value="<?php echo $config['cf_2'] ?>" id="cf_2" required class="required frm_input" size="40"><span style="color:red;">*계좌번호입력시 - 입력X 띄워쓰기로*</span></td>
        </tr>
        <tr>
			...
			<th scope="row"><label for="cf_3">예금주</label></th>
            <td><input type="text" name="cf_3" value="<?php echo $config['cf_3'] ?>" id="cf_3" required class="required frm_input" size="40"></td>
        </tr>
		<tr>
		<th scope="row"><label for="cf_4">vip 누적금액</label></th>
          <td><input type="text" name="cf_4" value="<?php echo $config['cf_4'] ?>" id="cf_4" required class="required frm_input" size="40"></td>
		  <th scope="row"><label for="cf_5">vvip 누적금액</label></th>
          <td><input type="text" name="cf_5" value="<?php echo $config['cf_5'] ?>" id="cf_5" required class="required frm_input" size="40"></td>
        </tr>
		<tr>
		<th scope="row"><label for="cf_6">N원이상 충전시</label></th>
          <td><input type="text" name="cf_6" value="<?php echo $config['cf_6'] ?>" id="cf_6" required class="required frm_input" size="40">원</td>
		  <th scope="row"><label for="cf_7">N% 지급 금액</label></th>
          <td><input type="text" name="cf_7" value="<?php echo $config['cf_7'] ?>" id="cf_7" required class="required frm_input" size="40">%</td>
        </tr>
		<th scope="row"><label for="cf_10">후기 작성시 포인트지급</label></th>
          <td colspan="3"><input type="text" name="cf_10" value="<?php echo $config['cf_10'] ?>" id="cf_10" required class="required frm_input" size="40"></td>
		  
        </tr>
		<tr>
		<th scope="row"><label for="cf_8">카카오톡 1:1 링크</label></th>
          <td><input type="text" name="cf_8" value="<?php echo $config['cf_8'] ?>" id="cf_8" required class="required frm_input" size="40"></td>
		  <th scope="row"><label for="cf_9">디스코드 링크</label></th>
          <td><input type="text" name="cf_9" value="<?php echo $config['cf_9'] ?>" id="cf_9" required class="required frm_input" size="40"></td>
        </tr>
        <tr>
