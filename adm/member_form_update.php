...
$sql_common = "  mb_name = '{$_POST['mb_name']}',
                 ...
                 mb_9 = '{$_POST['mb_9']}',
                 mb_10 = '{$_POST['mb_10']}',
				 mb_money = '{$_POST['mb_money']}',
				 mb_coin = '{$_POST['mb_coin']}'";
...
if ($w == '')
{
    ...
    // 닉네임중복체크
    $sql = " select mb_id, mb_name, mb_nick, mb_email from {$g5['member_table']} where mb_nick = '{$_POST['mb_id']}' ";
    $row = sql_fetch($sql);
    if ($row['mb_id'])
...
echo "<script>alert('입력되었습니다.');opener.location.href='./member_list.php';window.close();</script>";
?>