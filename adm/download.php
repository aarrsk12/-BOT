...
$sql = " select * from g5_write_download order by wr_good asc";
	...
	<div class="tbl_head01 tbl_wrap">
		...
		<tr>
				<td style="position:relative;">
					<?php if($i != '0'){ ?><a class="a_up a_updown" href="./download_good.php?mode=up&wr_good=<?php echo $list[$i]['wr_good']?>&wr_id=<?php echo $list[$i]['wr_id']?>">↑</a><?php } ?>
					<?php echo $list[$i]['wr_good']?>
					<?php if($i != count($list) - 1){ ?><a class="a_down a_updown" href="./download_good.php?mode=down&wr_good=<?php echo $list[$i]['wr_good']?>&wr_id=<?php echo $list[$i]['wr_id']?>">↓</a><?php } ?>
				</td>
