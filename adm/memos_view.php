...
$frm_submit = '<div class="btn_insert">
    ...
    <a href="./memos_form.php?wr_id='.$_GET["wr_id"].'&w=u" class="btn_insertadd">수정</a>'.PHP_EOL;
$frm_submit .= '</div>';
	...
	$(function() {
		...
		$('.shop_delete').on('click', function(){
			...
			if(result){
				...
				window.location.href = "memos_delete.php?wr_id="+num;
			}else{
...
<section id="anc_bo_basic">
    <div id="container_title">사용법 내용</div>
    <?php echo $pg_anchor ?>

    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption>사용법 내용</caption>
        <colgroup>
            <col class="grid_4">
            <col>
            <col class="grid_3">
