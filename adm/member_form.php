...
<div class="tbl_frm01 tbl_wrap">
	 <div id="container_title">회원 추가</div>
    <table>
    ...
    <tr>
        <th scope="row"><label for="mb_name">예금주<strong class="sound_only">필수</strong></label></th>
	...
	<tr>
		<th scope="row">충전금</th>
        <td><input type="text" name="mb_money" value="<?php echo $mb['mb_money'] ?>" id="mb_money" required class="required frm_input" size="15"  maxlength="20"></td>
	</tr>
	<tr>
		<th scope="row">적립금</th>
        <td><input type="text" name="mb_coin" value="<?php echo $mb['mb_coin'] ?>" id="mb_coin" required class="required frm_input" size="15"  maxlength="20"></td>
	</tr>
...
<div class="btn_insert">
    ...
    <a href="./member_list.php?<?php echo $qstr ?>" class="btn_insertadd">목록</a>
